...
namespace P1SmartMeter.Telegram.DSMR
{
    public class TelegramDefinition : TelegramDefinitionBase
    {
        ...
        protected TelegramDefinition()
        {
            ...
            DefineField(EquipmentIdentifier, "Equipment identifier", TelegramFieldType.OctetString);
            ...
            DefineField(MBUSClient1Ident, "M-Bus client 1 - identifier", TelegramFieldType.OctetString);
            ...
            DefineField(MBUSClient2Ident, "M-Bus client 2 - identifier", TelegramFieldType.OctetString);
            ...
            DefineField(MBUSClient3Ident, "M-Bus client 3 - identifier", TelegramFieldType.OctetString);
