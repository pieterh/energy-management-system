...
namespace TariffUnitTests
{
	public class TariffTests
	{
        ...
        public void TariffValidatesEqual()
        {
            ...
            var t2 = new Tariff(new DateTime(2022, 01, 09, 13, 35, 40, DateTimeKind.Utc), 0.1m, 0.1m);
            Assert.Equal(t1, t2);            
        }
        ...
        {
            var t1 = new Tariff(new DateTime(2022, 01, 09, 13, 35, 40, DateTimeKind.Utc), 0.1m, 0.1m);
            var t2 = new Tariff(new DateTime(2022, 01, 09, 13, 35, 40, DateTimeKind.Utc), 0.2m, 0.1m);
        ...
        {
            var t1 = new Tariff(new DateTime(2022, 01, 09, 13, 35, 40, DateTimeKind.Utc), 0.1m, 0.1m);
            var t2 = new Tariff(new DateTime(2022, 01, 09, 13, 35, 40, DateTimeKind.Utc), 0.1m, 0.2m);
            Assert.NotEqual(t1, t2);
        }
